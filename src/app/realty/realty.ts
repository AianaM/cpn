...
export class Address {
    ...
    static get features() {
        return [
            ...
            {name: 'Удобства', value: ['парковка/машино-место', 'видеонаблюдение', 'консьерж', 'пандус']},
            {name: 'Подключения', value: ['система очистки воды', 'газ', 'диспетчеризация коммунальных услуг']},
        ];
    }
}
